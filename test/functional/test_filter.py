...
def test_set():
    ...
    group_model = {
        ...
        "valueCols": [
            {"id": "gold", "aggFunc": "sum", "displayName": "gold", "field": "gold"}
        ],
        "pivotCols": [],
        "pivotMode": False,
        "groupKeys": [],
    ...
    assert (len(rows)) == 5
    assert rows == [
        {"country": "Australia", "gold": 0},
        {"country": "China", "gold": 3},
        {"country": "Romania", "gold": 5},
        {"country": "South Korea", "gold": 1},
        {"country": "United States", "gold": 4},
    ]
...
def test_text_filter_contains():
    df = pandas.DataFrame(
        columns=["a", "b", "c"],
        data=[["aaa", "bbb", "ccc"], ["aba", "bba", "cca"], ["abb", "baa", "cbb"]],
    )
    ...
    request = {
        ...
        "groupKeys": [],
        "filterModel": {
            "a": {"filterType": "text", "type": "contains", "filter": "ab"}
        },
        "sortModel": [],
    }
...
def test_text_filter_not_contains():
    ...
    request = {
        ...
        "groupKeys": [],
        "filterModel": {
            "a": {"filterType": "text", "type": "notContains", "filter": "ab"}
        },
        "sortModel": [],
    }
...
def test_text_filter_not_equals():
    ...
    request = {
        ...
        "groupKeys": [],
        "filterModel": {
            "a": {"filterType": "text", "type": "notEquals", "filter": "abb"}
        },
        "sortModel": [],
    }
...
def test_text_filter_startwith():
    ...
    request = {
        ...
        "groupKeys": [],
        "filterModel": {
            "a": {"filterType": "text", "type": "startsWith", "filter": "ab"}
        },
        "sortModel": [],
    }
...
def test_text_filter_endswith():
    ...
    request = {
        ...
        "groupKeys": [],
        "filterModel": {
            "a": {"filterType": "text", "type": "endsWith", "filter": "bb"}
        },
        "sortModel": [],
    }
...
def test_number_filter():
    df = pandas.DataFrame(
        columns=["a", "b", "c"],
        data=[[1, "bbb", "ccc"], [21, "bba", "cca"], [22, "baa", "cbb"]],
    )
...
def test_number_inRange_filter():
    df = pandas.DataFrame(
        columns=["a", "b", "c"],
        data=[[1, "bbb", "ccc"], [2, "bba", "cca"], [3, "baa", "cbb"], [4, "bb", "bb"]],
    )
    ...
    response = aggrid_values(df, request)
    assert response == {
        "rows": [{"a": 1, "b": "bbb", "c": "ccc"}, {"a": 2, "b": "bba", "c": "cca"}],
        "lastRow": 2,
        "secondaryColDefs": {},
    }
